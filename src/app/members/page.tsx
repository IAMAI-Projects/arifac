                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                        <div>
                            ...
                            <p className="text-gray-600">Our Members — {membersData.length} leading organisations in the ecosystem.</p>
                        </div>
                    ...
                    {filteredMembers.length === 0 && (
                        <div className="text-center py-20">
                            <p className="text-gray-400">No organisations found matching "{searchQuery}"</p>
                        </div>
                    )}
                </div>
            </div>

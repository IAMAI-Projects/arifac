                                ...
                                <div className="space-y-10">
                                    <div className="flex items-start gap-8">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:support@arifac.org" className="text-2xl font-bold text-[#1d1d1f] hover:text-accent transition-colors underline decoration-gray-200 underline-offset-8">
                                                support@arifac.org
                                            </a>
                                        </div>
                                    </div>

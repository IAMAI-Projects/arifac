        ...
        {accessItems.length > 0 && (
          <section className="py-6 lg:py-8 border-b border-neutral-100">
            <div className="max-w-[1240px] mx-auto px-6">
              <div className="mb-5">
                <span className="text-[11px] font-bold text-brand tracking-widest uppercase mb-2 block">{page.learnersSection?.accessEyebrow || 'Access'}</span>
                <h2 className="text-xl lg:text-[28px] font-extrabold text-neutral-900 leading-tight tracking-tight mb-2">
                  {page.learnersSection?.accessHeading || 'Building a foundation for you to learn, engage, and grow'}
                </h2>
                <p className="text-neutral-600 text-[15px] leading-[1.75] max-w-3xl">
                  {page.learnersSection?.accessDescription || 'Via access to:'}
                </p>
              </div>
            ...
            <div className="max-w-[1240px] mx-auto px-6">
              <div className="editorial-card p-6 lg:p-8 bg-brand/[0.03] border-brand/10">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-[11px] font-bold text-brand tracking-widest uppercase">{page.learnersSection?.ctaEyebrow || 'Open & Free'}</span>
                </div>
                <h2 className="text-xl lg:text-[28px] font-extrabold text-neutral-900 leading-tight tracking-tight mb-2">
                  {learnersCta.heading}
                </h2>

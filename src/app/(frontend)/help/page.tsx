      ...
      >
        <div className="grid md:grid-cols-2 gap-5">
          <div className="bg-neutral-50 border border-neutral-200 p-6">
            ...
            <a href="/faqs" className="text-[12px] font-bold uppercase tracking-wider text-brand hover:text-neutral-900 transition-colors">
              Open FAQs
            </a>
          </div>
          ...
          <div className="bg-white border border-neutral-200 p-6">
            ...
            <p className="text-[14px] text-neutral-600 leading-relaxed mb-2">For unresolved issues, contact the ARIFAC support desk:</p>

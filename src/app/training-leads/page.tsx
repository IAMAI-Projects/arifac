  ...
  return (
    <div className="group grid grid-cols-[48px_1fr] lg:grid-cols-[64px_minmax(180px,1.2fr)_1.5fr_1fr] items-start lg:items-center gap-x-4 gap-y-1 py-5 lg:py-6 border-b border-slate-200 last:border-b-0 hover:bg-slate-50/60 transition-colors duration-300">
      ...
      <div className="min-w-0">
        {lead.name ? (
          <h3 className="text-[15px] lg:text-[16px] font-bold text-slate-900 leading-snug tracking-tight">
            {lead.name}
          </h3>
        ) : (
      ...
      {lead.specialisation ? (
        <div className="col-span-2 lg:col-span-1 pl-[calc(48px+16px)] lg:pl-0 mt-1 lg:mt-0">
          <span className="inline-block text-[11px] font-bold uppercase tracking-[0.12em] text-slate-900/50 bg-brand/[0.04] border border-slate-900/[0.08] px-2.5 py-1">
            {lead.specialisation}
          </span>
        </div>
      ) : (
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hidden lg:grid lg:grid-cols-[64px_minmax(180px,1.2fr)_1.5fr_1fr] gap-x-4 pb-3 border-b-2 border-slate-900/10 mb-0">

          ...
          <div className="max-w-[1240px] mx-auto px-6">
           ...
           <div className="flex flex-wrap items-center gap-2 border border-slate-200 bg-slate-50 px-2.5 py-2">
                <select
                  ...
                  className="bg-transparent text-[12px] font-bold text-slate-700 px-2 py-1.5 focus:outline-none cursor-pointer"
                >
            ...
            <div className="space-y-3">
              ...
              {pageData.map((item, idx) => (
                <article
                  key={item.id}
                  className="group border border-slate-200 bg-white p-5 lg:p-6 hover:border-brand/35 hover:shadow-lg hover:shadow-slate-200/70 transition-all duration-300 animate-in"
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <span className="px-2.5 py-1 border border-slate-200 bg-slate-50 text-slate-600 text-[11px] font-bold uppercase tracking-wide">
                          {item.category}
                        </span>

  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 font-sans selection:bg-brand selection:text-white flex flex-col antialiased">
      ...
      <main className="flex-grow">
        ...
        <section className="py-12 lg:py-16 bg-white border-b border-slate-100">
          <div className="max-w-[1240px] mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-7 gap-6">
              {/* Threats — 2 cols */}
              <div className="lg:col-span-2 bg-slate-50 border border-slate-200 p-6 lg:p-8 relative overflow-hidden">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-white/10">
                  {[
                    ...
                    <div key={item.val} className="bg-white/[0.05] p-3">
                      <div className="text-[10px] font-bold text-brand-light uppercase tracking-widest mb-1.5">{item.label}</div>
        ...
        {/* ── What ARIFAC Does ── */}
        <section className="py-12 lg:py-16 bg-slate-50 border-b border-slate-100 relative overflow-hidden">
          ...
          <div className="max-w-[1240px] mx-auto px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={item.num} className="group relative bg-white border border-slate-200 p-6 lg:p-8 hover:border-brand/40 hover:shadow-lg transition-all duration-500 overflow-hidden">
                  {/* Background number */}
                  <div className="absolute top-4 right-6 text-[72px] font-black text-slate-50 group-hover:text-brand/[0.06] transition-colors pointer-events-none select-none leading-none">
                    {item.num}
                  </div>

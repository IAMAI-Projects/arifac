      ...
      data: {
        ...
        layout: [
          ...
          },
          {
            ...
            label: 'Partnerships',
            heading: 'Strategic Institutional Alignment',
            description: 'ARIFAC operates under the strategic guidance of FIU-IND (Financial Intelligence Unit — India), ensuring all programmes, initiatives, and frameworks are aligned with national AML/CFT priorities.',
            guidanceCard: {
              label: 'Strategic Guidance',
              title: 'Financial Intelligence Unit — India (FIU-IND), Ministry of Finance, Government of India',
              logoUrl: '',
            },
            disclaimer: 'ARIFAC is an industry body facilitated by IAMAI. It is not a regulatory authority and does not issue compliance certifications or approvals.',
          },
          {
            blockType: 'community',
            label: 'National Network',
            heading: "Join India's Leading Financial Intelligence Community",
            description: 'Connect with compliance leaders, regulatory experts, and industry pioneers working together to strengthen financial integrity across every sector.',
            links: [
              { eyebrow: 'For Organizations', title: 'Institutional Membership', href: '/membership' },
              { eyebrow: 'For Professionals', title: 'Individual Affiliate', href: '/membership' },
              { eyebrow: 'Certifications', title: 'Professional Pathways', href: '/certifications' },
              { eyebrow: 'Events', title: 'Programmes & Fora', href: '/programmes' },
            ],
            stat: { value: '175+', description: 'Reporting entities across banking, insurance, fintech, and capital markets' },

...
const pages = [
  ...
  },
  {
    ...
    slug: 'training-leads',
    pageType: 'training-leads' as const,
    banner: {
    ...
    trainingLeadsContent: {
      sectionEyebrow: 'Expert Network',
      sectionHeading: 'ARIFAC Training Lead Directory',
      sectionDescription: "Domain specialists appointed across India's financial ecosystem to lead certification, capacity building, and AML/CFT training initiatives.",
      numberHeader: 'No.',
      nameHeader: 'Name',
      organizationHeader: 'Organization',
      specialisationHeader: 'Specialisation',
      leadsCountLabel: 'Leads',
      specialisationsCountLabel: 'Specialisations',
  ...
  },
  {
    ...
    pageType: 'nodal-officers' as const,
    banner: {
    ...
    nodalOfficersContent: {
      ...
      fallbackDesignation: 'Principal Officer',
      sectorsCountLabel: 'Sectors',
      officersCountLabel: 'Officers',
      lastUpdated: 'Updated April 2026',
    },
  },
  {
    ...
    membersLabels: {
      directoryEyebrow: 'Member Directory',
      countLabel: 'Organisations',
      footerLabel: 'Member Organisations',
    },
  },
  {
    ...
    learnersSection: {
      ...
      accessHeading: 'Building a foundation for you to learn, engage, and grow',
      accessDescription: 'Via access to:',
      ctaEyebrow: 'Open & Free',
    },
  },
  {
    ...
    contributorFormLabels: {
      ...
      professionalBgHeader: 'Professional Background',
      expertiseHeader: 'Area of Expertise',
      expertiseInstruction: 'Select all that apply',
      contributionHeader: 'How You Can Contribute',
      contributionLabel: 'Tell us how you would like to contribute to ARIFAC',
      contributionPlaceholder: 'E.g. training delivery, content authoring, research, speaking at events, policy consultation...',
      linkedinLabel: 'LinkedIn Profile',
      linkedinPlaceholder: 'https://linkedin.com/in/...',
      submitLabel: 'Submit Application',
      successHeading: 'Thank you for your interest',
      successEyebrow: 'Submitted',
      successDescription: 'We have received your application. Our team will review your profile and get back to you shortly.',
      whyContributeHeader: 'Why Contribute',
  ...
  },
  {
    ...
    membershipSections: {
      benefitsEyebrow: 'What ARIFAC Engagement Enables',
      benefitsHeading: 'Capacity building and collaboration benefits for the financial intelligence ecosystem.',
      benefitsDescription: 'Benefits differ by engagement tier, with enhanced access for Members.',
      responsibilitiesEyebrow: 'Obligations',
      responsibilitiesHeading: 'Member / Affiliate Responsibilities',
      responsibilitiesDescription: 'Members are expected to maintain the highest standards of integrity, professionalism, and compliance.',
      responsibilitiesDisclaimer: 'Members must not disclose sensitive regulatory or transaction-related information, including Suspicious Transaction Reporting (STR)-related discussions or any confidential compliance data.',
      validityEyebrow: 'Terms',
      validityHeading: 'Validity & Renewal',
      feesEyebrow: 'Pricing',
      feesHeading: 'Fees',
      feesDescription: "Membership fees are determined by your organisation's self-declared annual turnover or Assets Under Management (AUM), as applicable. All fees are exclusive of taxes and subject to revision.",
      turnoverLabel: 'Turnover-Based',
      aumLabel: 'AUM-Based',
      feeSuffix: '+ taxes',
      turnoverColumnHeader: 'Turnover ₹',
      aumColumnHeader: 'AUM ₹',
      feeColumnHeader: 'Annual Fee',
    },
  },
  {
    ...
    certificationsUI: {
      ...
      searchLabel: 'Search',
      searchPlaceholder: 'Title, focus, topic...',
      levelLabel: 'Level',
      formatLabel: 'Format',
      clearFiltersLabel: 'Clear Filters',
      curriculumLabel: 'Curriculum',
      liveLabel: 'Live',
      liveDescription: 'This course is now live for employees of reporting entities, based on nominations received from their respective organisations.',
      comingSoonLabel: 'Coming Soon',
      noResultsMessage: 'No courses match the selected filters. Try adjusting your search or filter selections.',
    },
  },
  {
    ...
    updatesUI: {
      ...
      emptyMessage: 'No regulatory updates available at this time.',
      ...
      entries: [
        {
          label: 'Email Us',
          links: [
            { text: 'help@arifac.in', url: 'mailto:help@arifac.in' },
          ],
        },
        {
          label: 'Call Us',
...
export async function seed(payload: Payload) {
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      organizationLoginLabel: 'Organization',
      organizationLoginDescription: 'Member portal access',
      learnerLoginLabel: 'Learner',
      learnerLoginDescription: 'Learning platform access',
    },
  })
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      labels: {
        ...
        institutionalDialogueEyebrow: 'Institutional Dialogue',
        annualMeetingsDescription: 'Structured convergence platforms facilitating knowledge exchange and strategic alignment between ecosystem stakeholders.',
        programmeTableHeader: 'Programme',
        formatTableHeader: 'Format',
        timelineTableHeader: 'Timeline',
        yearTableHeader: 'Year',
        meetingTableHeader: 'Meeting',
  ...
  await payload.updateGlobal({
    slug: 'site-settings',
    data: {
      siteTitle: 'ARIFAC — Alliance of Reporting Entities in India for AML/CFT',
      siteDescription: "ARIFAC enables collaboration, capacity building, and coordinated action to strengthen India's financial crime prevention ecosystem under the guidance of FIU-IND.",
      categoryLabels: [
        { value: 'aml-cft', label: 'AML / CFT' },
        { value: 'kyc-cdd', label: 'KYC / Customer Due Diligence' },
        { value: 'reporting', label: 'Reporting' },
        { value: 'digital-onboarding', label: 'Digital Onboarding' },
        { value: 'fraud-cyber', label: 'Fraud & Cyber' },

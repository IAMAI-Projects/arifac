...
const translations: Record<Language, Record<string, string>> = {
    EN: {
        // Navbar
        'nav.certifications': 'ARIFAC Certifcations',
        ...
        'hero.scroll': 'Scroll',
        'hero.pillars_title': 'Pillars',
        'hero.pillar1_title': 'Capacity Building',
        'hero.pillar1_desc': '(Training, Certification, LMS)',
        'hero.pillar2_title': 'Industry Collaboration',
    ...
    HI: {
        ...
        'hero.subtitle_initiative': 'IAMAI द्वारा संचालित एक उद्योग पहल, जो भारत के वित्तीय खुफिया और AML/CFT ढांचे के अनुरूप है',
        ...
        'hero.nav_membership': 'सदस्यता के लिए आवेदन करें',
        'ARIFAC Membership - Login': 'ARIFAC Membership - Login',
        'ARIFAC Membership - Dashboard': 'ARIFAC Membership - Dashboard',
        'hero.nav_learning': 'AML/CFT शिक्षण कार्यक्रमों तक पहुँचें',
        'hero.nav_consultations': 'उद्योग परामर्श में भाग लें',
        ...
        'hero.pillars_title': 'स्तंभ',
        'hero.pillar1_title': 'क्षमता निर्माण',
        'hero.pillar1_desc': '(प्रशिक्षण, प्रमाणन, एलएमएस)',
        'hero.pillar2_title': 'उद्योग सहयोग',
        'hero.pillar2_desc': '(बंद कमरे में परामर्श, टाइपोलॉजी)',
        'hero.pillar3_title': 'नियामक संरेखण',
        'hero.pillar3_desc': '(FIU-IND, PMLA, FATF ढांचे)',
        'hero.disclaimer': 'ARIFAC एक गैर-नियामक उद्योग मंच है और यह अनुमोदन, लाइसेंस या अनुपालन प्रमाणपत्र प्रदान नहीं करता है।',

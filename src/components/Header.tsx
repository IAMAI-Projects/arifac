        ...
        <div className="max-w-[1240px] mx-auto px-6 h-16 lg:h-24 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-4 xl:gap-8 mx-auto">
            ...
            <div className="relative group/nav">
              <Link href="/certifications" className="text-[13px] font-bold text-slate-800 group-hover/nav:text-brand transition-colors whitespace-nowrap flex items-center gap-1.5">
                Certification
                <svg className="w-2.5 h-2.5 text-slate-300 group-hover/nav:text-brand group-hover/nav:translate-y-px transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="absolute top-full -left-4 pt-3 opacity-0 invisible translate-y-1 group-hover/nav:opacity-100 group-hover/nav:visible group-hover/nav:translate-y-0 transition-all duration-300 z-50">
                <div className="bg-white w-[260px] border border-slate-200 overflow-hidden relative">
                  {/* Top accent */}
                  ...
                  <div className="px-2 pb-3">
                    <Link href="/certifications" className="group/item flex items-center gap-3 px-3 py-2.5 hover:bg-slate-50 transition-colors">
                      ...
                      <div>
                        <span className="text-[12px] font-bold text-slate-900 block leading-tight group-hover/item:text-brand transition-colors">All Certifications</span>
                        <span className="text-[10px] text-slate-400">Browse learning pathways</span>
                      </div>
                    </Link>
                    <Link href="/training-leads" className="group/item flex items-center gap-3 px-3 py-2.5 hover:bg-slate-50 transition-colors">
                      <div className="w-7 h-7 bg-brand/[0.06] flex items-center justify-center flex-shrink-0 group-hover/item:bg-brand transition-colors duration-300">
                        <svg className="w-3.5 h-3.5 text-brand group-hover/item:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div>
                        <span className="text-[12px] font-bold text-slate-900 block leading-tight group-hover/item:text-brand transition-colors">Training Leads</span>
                        <span className="text-[10px] text-slate-400">Expert network directory</span>
                      </div>
                    </Link>
                  </div>
                </div>

      ...
      <div className="max-w-[1240px] mx-auto px-6">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-8 gap-6">
          <div className="max-w-xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 leading-tight">Professional Certification Framework</h2>
          ...
          <Link href="/certifications" className="text-neutral-900 font-bold border-b-2 border-brand pb-0.5 text-[13px] hover:text-brand transition-colors uppercase tracking-widest">
            View Certifications
          </Link>
        </div>
